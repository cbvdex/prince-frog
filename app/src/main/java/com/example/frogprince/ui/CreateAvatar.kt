    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == SELECT_IMAGE && resultCode == Activity.RESULT_OK
            ...
            try {
                ...
                var id : Long = manager.imageDAO.insertImage(byteArray)
                newImageLink = id.toString()
                Utility.println("received image: "+newImageLink)

                if (imageView != null && newImageLink!= null) {
                    val b: Bitmap? = manager.imageDAO.getImage(newImageLink!!)
